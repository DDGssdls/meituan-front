...
export default {
      ...
      curList: [
        {
          ...
          price: 666,
          img:
            "https://img.meituan.net/phoenix/14bc46b5740b7714df2dc3fbf27b542d1459696.jpg@1920w_1080h"
        },
        {
          title: "张三",
          pos: "保岱镇",
  ...
  methods: {
    handlerCilck: async function(el) {
      console.log(el.target.className);
      this.$router.push(`/detail?title=${el.target.className}`);
    },
