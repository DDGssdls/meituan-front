<template>
    <div class="m-nav">
        <ul class="nav">
            ...
            <li>
                <a href="https://i.meituan.com/mobile/down/meituan">手机APP</a>
                <!-- <nuxt-link to="https://i.meituan.com/mobile/down/meituan">手机APP</nuxt-link> -->
            </li>
            <li class="list bd">
                ...
                <dl>
                    ...
                    <dd><nuxt-link to="/kaipiao">商家申请链开票</nuxt-link></dd>
                </dl>
            </li>
            <li class="list site">
